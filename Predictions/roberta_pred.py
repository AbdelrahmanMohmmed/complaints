...
roberta = RobertaForSequenceClassification.from_pretrained(r"F:\FMS\Preprocessing and Training\Models\Probelm-Type-Classification\roberta_70").to(device)
# Load the trained tokenizer
tokenizer = AutoTokenizer.from_pretrained(r"F:\FMS\Preprocessing and Training\Models\Probelm-Type-Classification\roberta_70")
roberta.eval()

def pred_r(text : str, prob = False) -> str:
    """ 
    Docstring for pred_r function: 
