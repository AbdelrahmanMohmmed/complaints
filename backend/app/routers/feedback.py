...
def check_rate_limit(remote_address: str) -> bool:
    ...
    ip_rate_limit[remote_address] = [
        timestamp for timestamp in ip_rate_limit[remote_address]
...
def get_form(
    ...
    company = db.query(models.Company).filter(
        models.Company.company_id == integration.company_id
    ).first()
...
async def submit_form(
    ...
    feedback_context = submission.feedback_context.strip() if submission.feedback_context else ""
