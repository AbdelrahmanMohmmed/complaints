...
EMOTION_ID2LABEL = {0: "frustrated", 1: "neutral", 2: "disgusted", 3: "satisfied"}
...
def predict_emotion(text: str) -> str:
    ...
    try:
        ...
        try:
            ...
            logger.info(f"Emotion probabilities - frustrated: {probs[0]:.4f}, neutral: {probs[1]:.4f}, disgusted: {probs[2]:.4f}, satisfied: {probs[3]:.4f}")
        except:
            probs = None

        # Convert class ID to label
        emotion = EMOTION_ID2LABEL[pred_id]
