...
def predict_problem_type_label(text: str) -> str:
    ...
    try:
        if not text or text.strip() == "":
            ...
            return PROBLEM_TYPE_DEFAULT_LABEL
        ...
        logger.info(f"Problem type prediction: {final_pred} " f"(votes: {predictions})")
...
def _predict_ml_model(text: str) -> str:
    ...
    try:
        ...
        return PROBLEM_TYPE_ID2LABEL.get(pred_id, PROBLEM_TYPE_DEFAULT_LABEL)
    except Exception as e:
